...
export default function Home() {
    ...
    return (
        <div className="flex h-screen flex-col items-center justify-center bg-zinc-950 text-white font-sans relative overflow-hidden">
            ...
            <div className="absolute -top-40 -right-40 w-96 h-96 bg-red-900/10 blur-[100px] rounded-none"></div>
            ...
            <div className="relative z-10 flex flex-col items-center text-center max-w-2xl px-6">
                ...
                <h1 className="text-7xl md:text-8xl font-black uppercase tracking-tighter mb-4 text-white drop-shadow-lg leading-none">
                ...
                <div className="relative group">
                    ...
                    <div className="absolute -inset-1 bg-gradient-to-r from-red-600 to-red-800 blur opacity-25 group-hover:opacity-60 transition duration-500 group-hover:duration-200 rounded-none"></div>
                    
                    <button
                        onClick={handleCreateRoom}
                        className="relative flex items-center justify-center px-12 py-5 bg-zinc-900 text-white font-bold text-lg uppercase tracking-widest border border-zinc-700 hover:border-red-500 hover:bg-zinc-800 transition-all active:scale-95 group-hover:shadow-[0_0_30px_rgba(239,68,68,0.3)] rounded-none val-clip"
                    >
